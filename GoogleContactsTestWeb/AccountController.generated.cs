...
namespace GoogleContactsTestWeb.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : GoogleContactsTestWeb.Controllers.AccountController
    {
        ...
        [NonAction]
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, GoogleContactsTestWeb.Models.LoginModel model, string returnUrl);

        [NonAction]
        public override System.Web.Mvc.ActionResult Login(GoogleContactsTestWeb.Models.LoginModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
        ...
        [NonAction]
        partial void RegisterOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, GoogleContactsTestWeb.Models.RegisterModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Register(GoogleContactsTestWeb.Models.RegisterModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Register);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        [NonAction]
        partial void ManageOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, GoogleContactsTestWeb.Controllers.AccountController.ManageMessageId? message);

        [NonAction]
        public override System.Web.Mvc.ActionResult Manage(GoogleContactsTestWeb.Controllers.AccountController.ManageMessageId? message)
        {
        ...
        [NonAction]
        partial void ManageOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, GoogleContactsTestWeb.Models.LocalPasswordModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Manage(GoogleContactsTestWeb.Models.LocalPasswordModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Manage);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        [NonAction]
        partial void ExternalLoginConfirmationOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, GoogleContactsTestWeb.Models.RegisterExternalLoginModel model, string returnUrl);

        [NonAction]
        public override System.Web.Mvc.ActionResult ExternalLoginConfirmation(GoogleContactsTestWeb.Models.RegisterExternalLoginModel model, string returnUrl)
        {
